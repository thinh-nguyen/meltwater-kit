...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let documents = FHAIRouter.createFHAIDocumentNavBarController()
        
        window = UIWindow(frame: UIScreen.main.bounds)
        window?.rootViewController = documents
        window?.makeKeyAndVisible()
//              let documents = FHAIRouter.cr()
//        
//        let loginModule = FHAIRouter.createLoginModule()
//        window = UIWindow(frame: UIScreen.main.bounds)
...
//                window?.makeKeyAndVisible()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "MeltwaterKitDemo")
